      ...
      <div className="w-full max-w-lg rounded-2xl bg-ink-light p-8 shadow-xl border border-gold/20">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm text-slate-400">
            Bachelor&apos;s, Master&apos;s, and Doctorate programs offered in partnership with
          ...
          <form action={submitApplication} className="mt-6 space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">
                Program availability and fees vary by region — our admissions team will confirm
                details for your region by email.
              </p>
            </div>
            <div>
