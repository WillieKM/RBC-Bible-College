    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-ink px-4 py-12 text-center">
      ...
      <div className="mt-10 grid w-full max-w-2xl gap-4 sm:grid-cols-2">
        <div className="flex flex-col items-center rounded-2xl border border-gold/20 bg-ink-light p-6">
          ...
          <h2 className="mt-3 font-semibold text-gold">Applying from the USA</h2>
          <p className="mt-1 text-sm text-slate-400">Revelation Bible College International — Certificate through PhD</p>
          <Link
            href="/apply"
        ...
        <div className="flex flex-col items-center rounded-2xl border border-gold/20 bg-ink-light p-6">
          ...
          <h2 className="mt-3 font-semibold text-gold">Applying from Kenya / Outside the USA</h2>
          <p className="mt-1 text-sm text-slate-400">Bachelor&apos;s &amp; Master&apos;s — in partnership with Tabernacle Bible College and Seminary</p>
          <Link
            href="/apply/degree"
            className="mt-4 w-full rounded-lg bg-gold px-5 py-2.5 text-sm font-semibold text-ink hover:bg-gold-dark"
          >
