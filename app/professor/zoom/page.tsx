...
export default async function ProfessorZoomPage() {
  ...
  return (
    <div className="max-w-2xl">
      ...
      {upcoming.length === 0 && (
        <p className="mt-6 text-sm text-slate-500">No upcoming sessions scheduled.</p>
      )}

      <div className="mt-8">
        <h2 className="text-base font-semibold text-slate-800">Session Recordings</h2>
        <p className="mt-0.5 text-xs text-slate-400">Hosted on YouTube — share these links with students.</p>
        <div className="mt-3 space-y-3">
